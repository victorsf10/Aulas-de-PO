...
def cria_Graficos(lista_entrada):                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   #
  ...
  desenhaGrafico2(lista_entrada,tempos_orden_insert,tempos_orden_shell,tempos_orden_count,tempos_orden_quick,tempos_orden_merge,tempos_orden_bubble,tempos_orden_selec,tempos_orden_sort,"GraphBucketSort(Tam_List-X-Tem_Ordena)Lista_Aleatoria.png", "Tempo(Lista->Aleatória[Insertion+Bucket Sort])","Tempo(Lista->Aleatória[Shell+Bucket Sort])","Tempo(Lista->Aleatória[Counting+Bucket Sort])","Tempo(Lista->Aleatória[Quick+Bucket Sort])","Tempo(Lista->Aleatória[Merge+Bucket Sort])","Tempo(Lista->Aleatória[Bubble+Bucket Sort])","Tempo(Lista->Aleatória[Selection+Bucket Sort])","Tempo(Lista->Aleatória[Função'.Sort()'+Bucket Sort])",'(Bucket + .Sort()/Bubble/Selection/Quick/Merge/Insertion/Shell/Counting Sort - Lista: Aleatória - Amostragem Extra)Tamanho_Lista X Tempo_Ordenacoes','blue','magenta','lime','yellow','red','grey','orange','cyan',"<Entradas/>","<Tempo-Saída/>")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           #                                                                                                                                                                                                                                                                                                           
#}
